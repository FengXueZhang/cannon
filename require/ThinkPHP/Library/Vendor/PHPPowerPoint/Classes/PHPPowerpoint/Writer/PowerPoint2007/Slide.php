...
require_once '/../PowerPoint2007.php';

/** PHPPowerPoint_Writer_PowerPoint2007_WriterPart */
require_once '/WriterPart.php';
...
require_once '/../../Shape/RichText.php';

/** PHPPowerPoint_Shape_BaseDrawing */
require_once '/../../Shape/BaseDrawing.php';

/** PHPPowerPoint_Shape_Drawing */
require_once '/../../Shape/Drawing.php';

/** PHPPowerPoint_Shape_MemoryDrawing */
require_once '/../../Shape/MemoryDrawing.php';

/** PHPPowerPoint_Shared_Font */
require_once '/../../Shared/Font.php';

/** PHPPowerPoint_Shared_String */
require_once '/../../Shared/String.php';

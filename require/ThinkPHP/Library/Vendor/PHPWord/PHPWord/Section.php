...
class PHPWord_Section {
	...
	public function addLink($linkSrc, $linkName = null, $styleFont = null, $styleParagraph = null) {
		$linkSrc = $linkSrc;//utf8_encode($linkSrc)
		if(!is_null($linkName)) {
			$linkName = $linkName;//utf8_encode($linkName)
		}
	 ...
	 * @return PHPWord_Section_Object
	 */
	public function addMp3($src, $linkName = null , $style = null) {
		...
		if(!is_null($object->getSource())) {
			...
			$linkSrc = $src;//utf8_encode($linkSrc)
			if(!is_null($linkName)) {
				$linkName = $linkName;//utf8_encode($linkName)
			}
			
			$styleFont = $styleParagraph = null;

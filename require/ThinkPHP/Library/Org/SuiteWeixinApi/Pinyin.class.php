...
class Pinyin
{
     ...
     * Dict loader.
     *
     * @var \Project\Common\Pinyin\Src\DictLoaderInterface
     */
    protected $loader;
     ...
     * Constructor.
     *
     * @param \Project\Common\Pinyin\Src\DictLoaderInterface $loader
     */
    ...
    public function permalink($string, $delimiter = '-')
    {
        if (!in_array($delimiter, array('_', '-', '.', ''), true)) {
            throw new \Exception("Delimiter must be one of: '_', '-', '', '.'.");
        }
